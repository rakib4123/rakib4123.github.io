    ...
    <section id="about" className="py-24 bg-surface relative">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-[240px_1fr] gap-12 items-start">
          ...
          >
            <div className="relative w-52 h-52 md:w-60 md:h-60 rounded-full overflow-hidden shadow-[0_18px_36px_rgba(0,0,0,0.14)] hover:shadow-[0_20px_40px_rgba(196,22,47,0.12)] hover:-translate-y-1 transition-all duration-500">
              <Image
          ...
          >
            ...
            <p className="text-ink-soft text-[17px] mb-8 leading-relaxed">
              ...
              leakage;{" "}
              <strong className="text-ink">Drikon</strong> is a live
              e-commerce platform with a recommendation engine I mined from real
              order history;{" "}
              <strong className="text-ink">DhakaNight</strong> and{" "}
              <strong className="text-ink">PulseStone</strong> grew into
              papers too — three accepted in total, including IEEE COMPAS 2026.
              As founder of{" "}
              <strong className="text-ink">&quot;Khepa Chakka&quot;</strong>, I&apos;ve
              taken robots from concept to the competition floor. I&apos;m looking
              for opportunities in{" "}
              <strong className="text-ink">
                data science, machine learning, or full-stack development
              </strong>
              .
            </p>

            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-6 border-t border-line">
              {[
                ["Education", "B.Sc. CSE — AIUB"],
                ["Focus", "Data Science · ML · Full-Stack"],
                ["Role", "Founder, Khepa Chakka"],
                ["Affiliation", "ESAB, AIUB"],
                ["Languages", "Bangla · English"],
              ].map(([label, value]) => (
                <div key={label}>
                  <span className="block text-ink text-sm font-bold mb-0.5">
                    {label}
                  </span>
